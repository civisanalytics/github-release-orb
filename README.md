...
| `changelog-path` | string | File path to the changelog containing the description of the release. The format should follow typical Markdown style and [Changlog Semantics](https://keepachangelog.com/en/1.0.0/). | false | `CHANGELOG.md` |
